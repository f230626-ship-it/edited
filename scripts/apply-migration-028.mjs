/**
 * Apply migration 028 via Supabase Management API.
 * Needs SUPABASE_ACCESS_TOKEN in env or .env.local
 *
 * Run: node scripts/apply-migration-028.mjs
 */
...
const sql = readFileSync(
  resolve(root, "supabase/migrations/028_fix_project_notification_orphans.sql"),
  "utf8"
);
